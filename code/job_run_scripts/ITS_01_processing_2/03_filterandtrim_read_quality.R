...
# Find fastq files
fnFs <- sort(list.files(miseq_path, pattern="_1_filtered.fastq.gz$", full.names = TRUE))
fnRs <- sort(list.files(miseq_path, pattern="_2_filtered.fastq.gz$", full.names = TRUE))
